  ...
  return (
    <React.Fragment>
      ...
      <section className="bg-white rounded-sm flex w-3/5 mt-5 m-auto mb-5 min-h-full shadow-md dark:bg-gray-900 dark:max-md:bg-transparent max-lg:bg-transparent max-lg:min-w-full max-md::text-center max-md:flex-col max-md:justify-center items-center max-md:-mt-5 max-md:min-w-full max-md:shadow-none max-xl:bg-transparent max-xl:shadow-none max-xl:flex-col">
        <div className="w-5/12 h-5/12 p-3 mt-8 mb-8 ml-9 max-2xl:w-2/4 ">
          <ImageComponent src={"/avatar.jpg"} alt={"foto criada pela Lensa"} />
        </div>
        <div
          id="sobre"
          className="w-2/4 h-2/4 ml-2 -mt-4 max-md:min-w-full max-2xl:w-2/4"
        >
          <SectionTitle>Sobre mim:</SectionTitle>
          <div className="ml-8 max-md:min-w-full">
            <Paragraph>
              Especializado em Desenvolvimento Web, sou graduado em Engenharia
              da Computação. Apaixonado por programação, estou sempre em busca
              de ampliar e desenvolver o meu conhecimento na área. Acredito que
              tudo se resolve com comunicação e trabalho em equipe.
            </Paragraph>
          </div>
          ...
          <div className="flex items-center">
            ...
            <Paragraph>Engenharia da computação - Estácio-Iesam</Paragraph>
          </div>
          <div className="flex items-center">
            <CheckCircleIcon className="h-7  ml-8 dark:text-gray-100 max-md:mt-0 max-md:mr-2" />
            <Paragraph>Desenvolvimento Web Full Stack - Trybe.</Paragraph>
          </div>
          ...
          <div className="ml-4 flex items-center animate-bounce mt-3 dark:text-white">
            ...
            <a
              className="ml-2 mt-1 font-bold"
              href="https://drive.google.com/file/d/1MnK6T0YHWsZPUWiE2y14KrzsUUW0aUd2/view"
              target="-blank"
            >
              Download CV
            </a>
      ...
      <section className="bg-gray-300 rounded-sm flex-col w-3/5 -mt-5 m-auto mb-5 min-h-full shadow-md dark:max-md:bg-transparent max-lg:bg-transparent max-lg:min-w-full max-md::text-center  max-md:justify-center items-center max-md:-mt-5 max-md:min-w-full dark:bg-gray-700 max-md:shadow-none max-xl:shadow-none">
        <div
          className="flex justify-around max-md:w-full  m-auto "
          id="tecnologias"
        >
          <SectionTwoTitle>Tecnologias mais utilizadas</SectionTwoTitle>
        </div>
        ...
        <section>
          <div className="flex justify-center" id="projetos">
            <SectionTwoTitle>Projetos</SectionTwoTitle>
          </div>
          <div className="flex justify-center ">
            <CarouselProject />
          </div>
